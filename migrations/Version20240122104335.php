 ...
 */
final class Version20240122104335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE activitie activity TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activitie_user (activitie_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_C8B28E4A76ED395 (user_id), INDEX IDX_C8B28E4EB0ED4F5 (activitie_id), PRIMARY KEY(activitie_id, user_id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE category CHANGE activity activitie TINYINT(1) NOT NULL');
