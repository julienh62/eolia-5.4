...
class PurchaseRepository extends ServiceEntityRepository
{
    ...
    //permet de recuperer les commandes concernant une session Activity donnée
//permet de recuperer les commandes concernant une session Activity donnée
 /*   public function findPurchaseDetailsSql($id)
    {
        ...
        $sql = '
        SELECT c.start, c.end FROM Activity c JOIN purchase_item pi ON c.id = pi.activitie_id JOIN purchase p ON pi.purchase_id = p.id WHERE p.id = :id;
            ';
...
JOIN Activity c ON pi.activitie_id = c.id
