...
return [
    ...
    'app_admin_activitie_index' => [[], ['_controller' => 'App\\Controller\\Admin\\AdminActivitieController::index'], [], [['text', '/admin/activitie/']], [], [], []],
    'app_admin_activitie_show' => [['id'], ['_controller' => 'App\\Controller\\Admin\\AdminActivitieController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/activitie']], [], [], []],
    'app_admin_activitie_edit' => [['id'], ['_controller' => 'App\\Controller\\Admin\\AdminActivitieController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/admin/activitie']], [], [], []],
    'app_admin_activitie_delete' => [['id'], ['_controller' => 'App\\Controller\\Admin\\AdminActivitieController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/activitie']], [], [], []],
