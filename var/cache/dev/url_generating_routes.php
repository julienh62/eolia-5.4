...
return [
    ...
    'app_admin_calendar_index' => [[], ['_controller' => 'App\\Controller\\AdminCalendarController::index'], [], [['text', '/calendar']], [], [], []],
    'app_admin_formChooseCalendar' => [[], ['_controller' => 'App\\Controller\\AdminCalendarController::chooseLocationForm'], [], [['text', '/admin/createCalendarChoose']], [], [], []],
    ...
    'app_admin_calendar_show' => [['id'], ['_controller' => 'App\\Controller\\AdminCalendarController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/calendar']], [], [], []],
    'app_admin_calendar_edit' => [['id'], ['_controller' => 'App\\Controller\\AdminCalendarController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true]], [], [], []],
    'app_admin_calendar_delete' => [['id'], ['_controller' => 'App\\Controller\\AdminCalendarController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/calendardelete']], [], [], []],
