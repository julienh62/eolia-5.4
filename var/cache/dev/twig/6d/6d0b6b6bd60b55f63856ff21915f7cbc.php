...
class __TwigTemplate_23f345d1f5facb8ce837e7fedd14cb1c extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "admin/admin_staff/index.html.twig", 1);
...
{% block body %}
        ...
        {% for staff in staff %}
            <tr>
                ...
                <td>
                    ...
                    <a href=\"{{ path('app_admin_staff_edit', {'id': staff.id}) }}\">edit</a>
                </td>
            </tr>
        {% else %}
            <tr>
    ...
    <a href=\"{{ path('app_admin_staff_new') }}\">Create new</a>
{% endblock %}
