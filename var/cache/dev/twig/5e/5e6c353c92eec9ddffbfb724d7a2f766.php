...
<div class=\"onlydesktop\">
    <table class=\"tableau\">
        ...
        {% for item in items %}
            ...
            <tr>
                <td class=\"tableau\">{{ item.Activity.title }}</td>
            
                <td class=\"tableau\">{{ item.Activity.start ? item.Activity.start|date('Y-m-d H:i:s') : '' }}</td>
           
                <td class=\"tableau\">{{ item.Activity.end ? item.Activity.end|date('Y-m-d H:i:s') : '' }}</td>
           
                <td class=\"tableau\">{{  item.Activity.price | amount }}</td>
