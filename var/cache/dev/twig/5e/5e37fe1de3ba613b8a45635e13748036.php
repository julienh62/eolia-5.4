...
class __TwigTemplate_7f590104812d192d88fa6aaccdc3f950 extends Template
{
    private $source;
    private $macros = [];
...
<img class=\"imgsite\" src=\"";
        // line 13
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/images/" . twig_get_attribute($this->env, $this->source, (isset($context["image"]) || array_key_exists("image", $context) ? $context["image"] : (function () { throw new RuntimeError('Variable "image" does not exist.', 13, $this->source); })()), "image", [], "array", false, false, false, 13))), "html", null, true);
        echo "\" alt=\"";
        echo twig_escape_filter($this->env, (isset($context["categoryTitle"]) || array_key_exists("categoryTitle", $context) ? $context["categoryTitle"] : (function () { throw new RuntimeError('Variable "categoryTitle" does not exist.', 13, $this->source); })()), "html", null, true);
        echo " Baie de Somme\">
...
";
    ...
    {
        return array (  235 => 126,  231 => 124,  133 => 30,  123 => 29,  96 => 13,  89 => 8,  79 => 5,  60 => 3,  37 => 1,);
    }
