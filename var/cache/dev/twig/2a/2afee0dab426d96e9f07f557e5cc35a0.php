...
class __TwigTemplate_d352e967859d8069f7df31eb9761974c extends Template
{
    private $source;
    private $macros = [];
  ...
  <tbody>
     ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
          ...
          <td> ";
            // line 17
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["item"], "CalendarName", [], "any", false, false, false, 17), "html", null, true);
            echo "  </td>
         <td> ";
            // line 18
         ...
         <td> ";
            // line 19
            echo twig_escape_filter($this->env, (twig_get_attribute($this->env, $this->source, $context["item"], "calendarPrice", [], "any", false, false, false, 19) / 100), "html", null, true);
            echo " € </td>
         <td> ";
            // line 20
