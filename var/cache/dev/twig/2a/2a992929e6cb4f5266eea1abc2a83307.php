...
class __TwigTemplate_ea090f59a4cb27e85c9c3b9aecb2f1da extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<img src=\"";
     ...
     <div class=\"dropdown-1\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_agenda_by_category", ["categoryTitle" => twig_get_attribute($this->env, $this->source, $context["category"], "title", [], "any", false, false, false, 13)]), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return array (  173 => 77,  163 => 70,  154 => 64,  135 => 48,  132 => 47,  126 => 44,  121 => 42,  118 => 41,  111 => 37,  108 => 36,  103 => 33,  97 => 29,  95 => 28,  82 => 18,  77 => 15,  66 => 13,  62 => 12,  58 => 11,  49 => 5,  43 => 1,);
    }
        ...
        <button>Consulter le planning</button> 
            <div class=\"content\">
             <a href=\"{{ path('app_agenda') }}\"> Toutes les activités</a> 
                ...
                <a class=\"asous\" href=\"{{ path('app_agenda_by_category', {'categoryTitle': category.title}) }}\">{{ category.title }}</a>
              {% endfor %}
            </div>
    </div>
