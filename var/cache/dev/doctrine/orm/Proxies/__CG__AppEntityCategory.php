...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function getCategorySetting(): ?\App\Entity\CategorySetting
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCategorySetting', []);

        return parent::getCategorySetting();
    }

    /**
     * {@inheritDoc}
     */
    public function setCategorySetting(\App\Entity\CategorySetting $categorySetting): static
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCategorySetting', [$categorySetting]);

        return parent::setCategorySetting($categorySetting);
    }
