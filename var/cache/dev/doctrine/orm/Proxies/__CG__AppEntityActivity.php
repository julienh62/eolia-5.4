...
class Activity extends \App\Entity\Activity implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'stock', 'price', 'modifiedPrice', '' . "\0" . 'App\\Entity\\Activity' . "\0" . 'purchaseItems', '' . "\0" . 'App\\Entity\\Activity' . "\0" . 'users', 'id', 'title', 'start', 'end', 'staffs', 'category'];
        }
