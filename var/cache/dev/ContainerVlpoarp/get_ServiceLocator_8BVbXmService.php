...
class get_ServiceLocator_8BVbXmService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->privates['.service_locator.8_BVbXm'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'calendar' => ['privates', '.errored..service_locator.8_BVbXm.App\\Entity\\Calendar', NULL, 'Cannot autowire service ".service_locator.8_BVbXm": it references class "App\\Entity\\Calendar" but no such service exists. You should maybe alias this class to the existing "App\\Entity\\Activity" service.'],
        ], [
