 ...
 */
class getCategoryColorSettingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategoryColorSettingRepository' shared autowired service.
     *
     * @return \App\Repository\CategoryColorSettingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategoryColorSettingRepository.php';

        return $container->privates['App\\Repository\\CategoryColorSettingRepository'] = new \App\Repository\CategoryColorSettingRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
